...
if __name__ == "__main__":
    try:
        ...
        shutil.copytree("../apps", "../initrd/apps")
        ...
        if sys.platform == "linux" or sys.platform == "linux2":
            ...
            os.system("""wsl grub-mkrescue -o "SwanOS.iso" isodir/ -V SwanOS """)

        os.system("qemu-system-i386 -d int -m 8 -name SwanOS -soundhw all -cdrom SwanOS.iso -fdb fdb.img -hda ata.qcow2 -serial  file:Qemu.log -no-reboot")
